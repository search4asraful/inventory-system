        ...
        <div class="d-flex">
            ...
            <form class="app-search d-none d-lg-block">
                <div class="position-relative">
                    <label for="sm-search-tab" class="d-none"></label>
                    <input type="text" name="new-search" class="form-control" placeholder="Search..." id="sm-search-tab" autocomplete="search">
                    ...
                    <form class="p-3">
                        <div class="mb-3 m-0">
                            <div class="input-group">
                                <label for="search-tab" class="d-none"></label>
                                <input type="text" class="form-control" placeholder="Search ..." id="search-tab" autocomplete="search" name="new-search">
